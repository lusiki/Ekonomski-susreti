...
#show figure.caption: it => align(left)[
  #v(0.2em)
  #text(size: 7.6pt, weight: "regular", fill: luma(85))[#it.body]
]

#block(width: 100%, below: 2.4em)[
  #text(size: 7.4pt, weight: 700, tracking: 0.2em)[EKONOMSKI SUSRETI]
  #v(0.6em)
  #line(length: 100%, stroke: 0.5pt + black)
  #v(1.5em)
  #block(width: 100%)[
    #set par(leading: 0.36em)
    #text(size: 31pt, weight: 200, tracking: -0.31pt)[
  ...
  #v(1.5em)
  #text(size: 7.4pt, weight: 700, tracking: 0.16em, fill: luma(85))[
