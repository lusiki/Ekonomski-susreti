...
nakuplja i na kraju ga nitko ne placa.
...
- Ne ureduj datoteke u `results/` ni `data/derived/`, one su generirane.
- Ne diraj `data/restricted/`.
- Ne mijenjaj izbor specifikacije bez razgovora. Predlozi ga.

## Ako provjera padne

Prijavi koja je pala i sto mislis da je uzrok, prije nego sto pocnes popravljati.
